    ...
    >
        <div class="grid h-full max-w-lg grid-cols-4 mx-auto font-medium">
            ...
            >
                <svg
                    data-outlined
                    class="w-6 h-6 group-hover:text-blue-600"
                    aria-hidden="true"
                ...
                >
                    <path
                        d="M9.77143 0.5L0 7.5V21H7.05714V13H13.0286V21.5H19V7L9.77143 0.5Z"
                    />
                </svg>
            </NavBarElement>
            ...
            >
                ...
                >
                    ...
                    />
                    <path
                        d="M6.39137 1.86957L1.36963 3.69565V19.6739L6.39137 17.8478V1.86957Z"
                    />
                    <path
                        d="M19.6306 2.32611L14.6089 4.1522V20.1305L19.6306 18.3044V2.32611Z"
                    />
                </svg>
            </NavBarElement>
            ...
            <NavBarElement
                label="Favoris"
                href="/favoris"
                :class="{ active: isUrl('favoris', 'login') }"
            >
                <svg
                    data-outlined
                    class="w-6 h-6 group-hover:text-blue-600"
