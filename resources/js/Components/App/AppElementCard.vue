    ...
    <article
        ...
        >
            ...
            <div class="flex-1 flex flex-col justify-center px-5 py-2">
                ...
                <!-- Navigation infos -->
                <Text v-if="navigation" type="s" class="">Durée du trajet : <ImpactText class="inline" type="xs">{{ navigationInfos.duration }}</ImpactText></Text>
                <div v-if="navigation" class="flex gap-6 flex-row mt-2">
