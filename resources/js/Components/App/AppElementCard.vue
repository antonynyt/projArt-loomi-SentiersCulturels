...
<template>
    <article class="border border-gray-300 rounded-2xl cursor-pointer">
        <a :href="props.type === 'path' ? props.href : null" @click.prevent="handleClick" class="flex justify-between">
            ...
            <div class="grow flex flex-col justify-center px-5 py-2">
                ...
                <div v-if="type === 'path'" class="flex flex-row justify-between mt-3 gap-1 flex-wrap">
                    <div class="text-sm text-gray-500 flex flex-row items-center no-wrap gap-1">
