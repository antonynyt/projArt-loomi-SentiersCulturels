...
console.log(
    "finished:" + props.finishedPaths.length,
    "total:" + pathCount.value
);

progressWidth.value = `${
    (props.finishedPaths.length * 100) / pathCount.value
}%`;
...
<template>
    ...
    <DefaultLayout>
        <ContentLayout class="">
            <BackLink />
            <TheHeader title="Sentiers terminés" class="mb-2 self-center" />
            <div class="pb-6">
