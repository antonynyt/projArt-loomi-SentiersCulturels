    ...
    public function run(): void
    {
        ...
        $achievements = [
            [
                ...
                'image' => asset('storage/images/achievements/legende.png'),
            ...
            [
                ...
                'image' => asset('storage/images/achievements/expert.png'),
                'next_achievement' => 6,
            ],
            [
                'id' => 4,
                ...
                'image' => asset('storage/images/achievements/aventurier.png'),
                'next_achievement' => 5,
            ],
            [
                'id' => 3,
                ...
                'image' => asset('storage/images/achievements/explorateur.png'),
                'next_achievement' => 4,
            ],
            [
                'id' => 2,
                ...
                'image' => asset('storage/images/achievements/randonneur.png'),
                'next_achievement' => 3,
            ],
            [
                'id' => 1,
                ...
                'image' => asset('storage/images/achievements/debutant.png'),
                'next_achievement' => 2,
            ],
        ];
